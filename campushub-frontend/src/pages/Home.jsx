  ...
  return (
    <>
      ...
      <div className="flex h-[calc(100vh-80px)] bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/50 overflow-hidden">
        {/* Enhanced Sidebar */}
        <div className=" hidden sm:hidden lg:block  w-80 flex-shrink-0 h-full border-r border-gray-150 bg-white/80 backdrop-blur-sm shadow-2xl">
          <Sidebar />
        </div>
...
<div className="flex-1 min-w-0 overflow-hidden">
  <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-6 lg:py-16">
      
      {/* 🔥 MOBILE STACKED LAYOUT - DESKTOP FLEX */}
      <div className="lg:flex lg:gap-12 w-full">
        
        {/* 🔥 LEFT COLUMN - CreatePost + Mobile Cards + Posts */}
        <div className="lg:w-[65%] order-2 lg:order-1 flex-shrink-0">
          <div className="space-y-6 lg:space-y-10 pr-0 lg:pr-16">
            
            {/* ✅ 1️⃣ CreatePost - Always top */}
            <CreatePost />
            
            {/* ✅ 2️⃣ MOBILE ONLY: Individual RightSidebar Cards */}
            <div className="block lg:hidden space-y-6 w-full">
              ...
              {/* Active Users */}
              <div className="h-72 w-full">
                <RightSidebarActiveUsers />
              </div>
              
              {/* Resources */}
              <div className="h-[22rem] w-full">
                <RightSidebarResources />
              </div>
            </div>
            
            {/* ✅ 3️⃣ Posts */}
            {error && (
              <div className="p-8 sm:p-10 bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200/50 rounded-3xl shadow-2xl text-center mx-auto max-w-2xl">
            ...
            {posts.length === 0 ? (
              <div className="text-center py-24 sm:py-32 lg:py-48 text-gray-500 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-200 shadow-2xl mx-auto max-w-2xl">
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                {hasMore && (
                  <div className="text-center py-16 sm:py-20 bg-white/70 backdrop-blur-sm rounded-3xl border border-gray-200 shadow-2xl mx-auto max-w-2xl">
                           <button
        ...
        {/* 🔥 RIGHT COLUMN - DESKTOP ONLY: Single RightPanel */}
